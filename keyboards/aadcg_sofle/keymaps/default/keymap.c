...
[0] = LAYOUT(
  ...
  KC_TAB,    KC__A, KC__S,  KC__D, KC__F,   KC__G,                   KC__H, KC__J, KC__K,    KC_L,    KC_SCLN, KC_BSPC,
  KC__MINUS, KC_Z,  KC_X,   KC__C, KC_V,    KC__B, KC_MUTE, KC_PSCR, KC_N,  KC_M,  KC__COMM, KC__DOT, KC_SLSH, KC_BSLS,
                    KC_ESC, SUP,   SC_LSPO, C_SPC, C_M_RET, C_M_SPC, M_RET, TT(1), SC_RSPC,  ALTGR
),
...
[1] = LAYOUT(
  ...
  _______, XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_R, KC_LBRC,                    KC_RBRC, KC_UP,   KC_DOWN, KC_LEFT, KC_RIGHT, _______,
  _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN3, XXXXXXX, _______,  _______, XXXXXXX, KC_PGUP, KC_PGDN, XXXXXXX, XXXXXXX,  _______,
